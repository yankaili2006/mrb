    ...
    <![endif]-->
		...
		<script type="text/javascript">
			...
			function updateproject(){
			    $('#act').val("update");
			    $('#msg').val("{pid:" + $('#pid').val() + ",name:" + $('#name').val() + ",iid:" + $('#iid').val() + ",level:" + $('#level').val() + ",area:" + $('#area').val() + ",store:" + $('#store').val() + ",build:" + $('#build').val() + ",pack:" + $('#pack').val() + ",sale:" + $('#sale').val() + ",chain:" + $('#chain').val() + ",fee:" + $('#fee').val() + ",date:" + $('#date').val()  + "}");
				$('#updateform').submit();
			}
