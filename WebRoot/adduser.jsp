...
.brand .second {
    ...
    <![endif]-->
		...
		<script type="text/javascript">
			...
			function adduser(){
			    $('#act').val("add");
			    $('#msg').val("{uname:" + $('#uname').val() + ",phone:" + $('#phone').val() + ",pwd:" + $('#pwd').val() + ",status:" + $('#status').val() + "}");
				$('#addform').submit();
			}
				...
				<div class="span3">
					<div class="sidebar-nav">
						...
						<ul id="dashboard-menu" class="nav nav-list collapse in">
							...
							<li>
								<a href="user.jsp">项目列表</a>
							</li>
							<li>
								<a href="user.jsp">品牌分类</a>
							</li>
						</ul>
							...
							<div class="tab-pane active in" id="home">
								<form id="tab">
									...
									<input type="text" name="uname" id="uname"
										value="<% if (bean != null)out.print(bean.getUname());%>"
										class="input-xlarge">
									<label>
										手机号
									</label>
									<input type="text" name="phone" id="phone"
										value="<% if (bean != null)out.print(bean.getPhone());%>"
										class="input-xlarge">
									<label>
										密码
									</label>
									...
									<input type="password" id="pwd2" name="pwd2" class="input-xlarge">
									<label>
										状态
									</label>
									<select name="status" id="status" class="input-xlarge">
										<option value="Z"
											<% if(bean != null && "Z".equals(bean.getStatus())){ out.print("selected=\"selected\"");} %>>
											正常
										</option>
										<option value="C"
											<% if(bean != null && "C".equals(bean.getStatus())){ out.print("selected=\"selected\"");} %>>
											注销
										</option>
									</select>
								</form>
