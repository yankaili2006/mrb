    ...
    <![endif]-->
		<script type="text/javascript">
			function delpcate(){
			   ...
			   function(data){
			     if (data != "ok"){
			        ...
			        alert("删除成功");
			        window.location.href="pcate.jsp";
			     }
			   });
			}
			...
			function updatepcate(){
			    $('#act').val("update");
			    $('#msg').val("{cid:" + $('#cid').val() + ",name:" + $('#name').val() + "}");
				$('#updateform').submit();
			}
							...
							<div class="tab-pane active in" id="home">
								<form id="tab">
									...
									<input type="text" id="name" name="name"
										value="<% if (bean != null)out.print(bean.getName()); %>" class="input-xlarge">

									<input type="hidden" id="cid" name="cid"
										value="<%if (bean != null)out.print(bean.getCid()); %>">
									<%
