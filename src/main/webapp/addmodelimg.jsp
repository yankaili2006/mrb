...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<h1 class="page-title">添加模块图片</h1>
				<div class="btn-toolbar">
					<button class="btn btn-primary" onclick="addmodelimg();">
				...
				<div class="well">
					...
					<form id="addform" name="addform" action="modelimg.do"
						method="post">
						...
						<div class="tab-pane active in" id="home">
							...
							out.print("selected=\"selected\"");%>>
								...
								<label> 模块内显示次序 </label> <input type="text" name="idx" id="idx"
									...
									模块图片 </label> <input type="text" name="iuri" id="iuri"
								...
								<select name="model" id="model" class="input-xlarge">
									<%
										for (int i = 0; i < paramList.length; i++) {
									%>
									<option value="<%=paramList[i]%>"><%=paramList[i]%></option>
									<%
										}
									%>
								</select>
								...
								%>
								<label> 模块内显示次序 </label> <input type="text" name="idx" id="idx"
									value="" class="input-xlarge"> <label> 模块图片 </label> <input
