...
<script type="text/javascript">
	function deluser() {
		$.post("user.do", {
			...
			if (data != "ok") {
				...
				$.post("user.do?act=list", function(data) {
					$("#usergrid").html(data);
				});
			}
		});
	...
	function load(page) {
		$.post("user.do?act=list&msg={p:" + page + "}", function(data) {
			$("#usergrid").html(data);
		});
	}
</script>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				%>
				<!-- 位置重要 -->
				<form name="edituid" id="edituid" action="user.do" method="post">
