...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<h1 class="page-title">编辑品牌图片</h1>
				<div class="btn-toolbar">
					<button class="btn btn-primary" onclick="updatebimg();">
				...
				<div class="well">
					...
					<form id="updateform" name="updateform" action="bimg.do"
						method="post">
