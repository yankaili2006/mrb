...
<script type="text/javascript">
	function delvideo() {
		$.post("video.do", {
			...
			if (data != "ok") {
				...
				$.post("video.do?act=list", function(data) {
					$("#videogrid").html(data);
				});
			}
		});
	...
	function gotoedit(obj) {
		...
		$('#vid').val(tds.eq(0).text());
		$('#msg').val("{vid:" + tds.eq(0).text() + "}");
		$('#editvid').submit();
	}
	...
	function load(page) {
		$.post("video.do?act=list&msg={p:" + page + "}", function(data) {
			$("#videogrid").html(data);
		});
	}
</script>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span3">
				<div class="sidebar-nav">
					...
					<ul id="dashboard-menu" class="nav nav-list collapse in">
						...
						<li><a href="user.html">Sample List</a></li>
			...
			<div class="span9">
				...
				%>
				<!-- 位置重要 -->
				<form name="editvid" id="editvid" action="video.do" method="post">
