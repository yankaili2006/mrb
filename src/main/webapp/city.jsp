...
<script type="text/javascript">
	...
	function load(page) {
		$.post("city.do?act=list&msg={p:" + page + "}", function(data) {
			$("#citygrid").html(data);
		});
	}
</script>
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				%>
				<!-- 位置重要 -->
				<form name="editcid" id="editcid" action="city.do" method="post">
				...
				<div class="modal small hide fade" id="myModal" tabindex="-1"
					...
					<div class="modal-body">
						<p class="error-text">
							<i class="icon-warning-sign modal-icon"></i>您确定删除该城市?
						</p>
					</div>
